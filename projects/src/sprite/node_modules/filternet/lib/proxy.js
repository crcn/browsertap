...
module.exports.createProxyServer = function (opts) {
    ...
    if (opts['transSslPort']) {
        /*var transSslServer = net.createServer(function (socket) {
         ...
         var opps = {key:  fs.readFileSync(sslCerts['*'][0]),
                          cert: fs.readFileSync(sslCerts['*'][1])};

        var transSslServer = https.createServer(opps, serverDefinition(true));


        transSslServer.listen(opts['transSslPort']);
