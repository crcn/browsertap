...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=mingw32 --cross-prefix=x86_64-w64-mingw32- --cc=x86_64-w64-mingw32-gcc --arch=x86_64 --enable-shared --disable-static --enable-gpl
prefix=/usr/local
...
CC_IDENT=gcc 4.7.0 (GCC) 20111220 (experimental)
ARCH=x86
...
HOSTCC=gcc
HOSTLD=gcc
HOSTCFLAGS=-D_ISOC99_SOURCE -D_XOPEN_SOURCE=600 -O3 -g 
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTLIBS=-lm
DEPHOSTCC=gcc
...
EXTRALIBS=-lavicap32 -lws2_32 -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
INSTALL=install
