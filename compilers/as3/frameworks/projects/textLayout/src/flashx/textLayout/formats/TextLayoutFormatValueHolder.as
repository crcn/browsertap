//========================================================================================
//  $File: //a3t/argon/branches/v1/1.1/dev/textLayout_core/src/flashx/textLayout/formats/TextLayoutFormatValueHolder.as $
//  $DateTime: 2010/03/25 16:56:08 $
//  $Revision: #3 $
//  $Change: 745780 $
//  
//  ADOBE CONFIDENTIAL
	...
	public class TextLayoutFormatValueHolder implements ITextLayoutFormat
	{
		...
		private function initialize(initialValues:ITextLayoutFormat):void
		{
			...
			if (initialValues)
			{
				...
				if (holder)
				{
					var holderCoreStyles:Object = holder._coreStyles;
					for (var s:String in holderCoreStyles)
						writableCoreStyles()[s] = holderCoreStyles[s];
				}
		...
		{
			if (_coreStyles == emptyCoreStyles)
				_coreStyles = new Object();
			return _coreStyles;
		}

		public function get coreStyles():Object
		{ return _coreStyles == emptyCoreStyles ? null : _coreStyles; }
		public function set coreStyles(val:Object):void
		{ _coreStyles = val ? val : emptyCoreStyles; }

		private function getCoreStyle(styleProp:String):*
		{ return _coreStyles[styleProp]; }
		...
		public function set format(incoming:ITextLayoutFormat):void
		{
			...
			if (holder)
			{
				_coreStyles = holder._coreStyles == emptyCoreStyles ? emptyCoreStyles : Property.shallowCopy(holder._coreStyles);
				return;
			}
		...
		public function concat(incoming:ITextLayoutFormat):void
		{
			...
			{
				var holderCoreStyles:Object = holder._coreStyles;
				for (var key:String in holderCoreStyles)
				{
		...
		public function apply(incoming:ITextLayoutFormat):void
		{
			...
			if (holder)
			{
				...
				for (var key:String in holderCoreStyles)
				{
					CONFIG::debug { assert(holderCoreStyles[key] !== undefined,"bad value in apply"); }
		...
		{ return _coreStyles.backgroundColor; }
		...
		{ return _coreStyles.lineThrough; }
		...
		{ return _coreStyles.backgroundAlpha; }
		...
		{ return _coreStyles.baselineShift; }
		...
		{ return _coreStyles.trackingLeft; }
		...
		{ return _coreStyles.trackingRight; }
		...
		{ return _coreStyles.breakOpportunity; }
		...
		{ return _coreStyles.dominantBaseline; }
		...
		{ return _coreStyles.ligatureLevel; }
		...
		{ return _coreStyles.alignmentBaseline; }
		...
		{ return _coreStyles.typographicCase; }
		...
		{ return _coreStyles.textDecoration; }
		...
		{ return _coreStyles.whiteSpaceCollapse; }
		...
		{ return _coreStyles.renderingMode; }
		...
		{ return _coreStyles.textRotation; }
		...
		{ return _coreStyles.paragraphStartIndent; }
		...
		{ return _coreStyles.paragraphEndIndent; }
		...
		{ return _coreStyles.paragraphSpaceBefore; }
		...
		{ return _coreStyles.paragraphSpaceAfter; }
		...
		{ return _coreStyles.textAlignLast; }
		...
		{ return _coreStyles.textJustify; }
		...
		{ return _coreStyles.justificationRule; }
		...
		{ return _coreStyles.justificationStyle; }
		...
		{ return _coreStyles.leadingModel; }
		...
		{ return _coreStyles.paddingLeft; }
		...
		{ return _coreStyles.paddingRight; }
		...
		{ return _coreStyles.paddingBottom; }
		...
		{ return _coreStyles.columnCount; }
		...
		{ return _coreStyles.columnWidth; }
		...
		{ return _coreStyles.firstBaselineOffset; }
		...
		{ return _coreStyles.verticalAlign; }
		...
		{ return _coreStyles.blockProgression; }
