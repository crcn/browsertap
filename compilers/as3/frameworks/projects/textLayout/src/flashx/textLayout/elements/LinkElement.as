	...
	public final class LinkElement extends SubParagraphGroupElement implements IEventDispatcher
	{
		...
		*/
		...
		private function computeLinkFormat(formatName:String):TextLayoutFormatValueHolder
		{
			...
			else if (linkStyle is TextLayoutFormatValueHolder)
		...
		{	
			var cf:TextLayoutFormatValueHolder;
		...
		tlf_internal override function get formatForCascade():TextLayoutFormatValueHolder
		{
			var superFormat:TextLayoutFormatValueHolder = _formatValueHolder;
			var effectiveFormat:TextLayoutFormatValueHolder = effectiveLinkElementTextLayoutFormat;
